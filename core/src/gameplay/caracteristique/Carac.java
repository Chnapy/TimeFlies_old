...
public enum Carac {
	 ...
	 * Les sorts actifs utilisent le temps d'action. Ce temps d'action diminue pendant
	 * le tour de jeu de l'entité en fonction du temps.
	 */
	TEMPSACTION,
	/**
	 * Le temps supplémentaire d'une entité active.
	 * Ce temps est utilisé lorsqu'un sort actif est en cours d'exécution et qu'il
	 ...
	 * La vitesse d'action fait varier le niveau de temps d'action utilisé par les sorts actifs.
	 */
	VITESSEACTION
}
